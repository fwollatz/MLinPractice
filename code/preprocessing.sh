...
python -m code.preprocessing.run_preprocessing data/preprocessing/labeled.csv data/preprocessing/preprocessed.csv  -e data/preprocessing/pipeline.pickle --tokenize -stem --punctuation --filter_englisch --lower_case --stop_word_removal --filter_emojis_urls --extract_emojis
